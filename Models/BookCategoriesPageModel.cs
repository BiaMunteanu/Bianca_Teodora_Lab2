...
namespace Bianca_Teodora_Lab2.Models
{
    public class BookCategoriesPageModel :PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Bianca_Teodora_Lab2Context context,
        Book book)
        {
        ...
        public void UpdateBookCategories(Bianca_Teodora_Lab2Context context,
